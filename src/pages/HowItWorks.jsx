...
export default function HowItWorks() {
  ...
  return (
    <div className="how-it-works-container">
      ...
      <section className="group">
        ...
        <div className="group-cards">
          <article className="info-card" tabIndex={0}>
            <span className="info-icon">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="icon">
                <path d="M4 8.5C4 7.4 4.9 6.5 6 6.5H8.2L9.2 5H14.8L15.8 6.5H18C19.1 6.5 20 18.5V16.5C20 17.6 19.1 18.5 18 18.5H6C4.9 18.5 4 17.6 4 16.5V8.5Z" stroke="#2D6A4F" strokeWidth="1.8" strokeLinejoin="round"/>
      ...
      <div>
        <button className="btn-primary" id="startBtn" onClick={() => navigate('/home')} style={{ marginTop: '12px', padding: '14px 32px' }}>
